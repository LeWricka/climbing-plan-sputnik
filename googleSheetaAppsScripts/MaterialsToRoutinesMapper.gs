...
function getMaterialsToRoutinesMapper(e) {
    var sheet = SpreadsheetApp.getActive().getSheetByName('routines');
    var rowsData = getRowsData_(sheet, getExportOptions(e));
    var materialsToRoutinesMapper = {'materialsToRoutinesMapper': rowsData}
    return materialsToRoutinesMapper
}
